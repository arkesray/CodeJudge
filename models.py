...
class events(db.Model):
    ...
    def __init__(self, name, etype = 0, st=datetime.datetime.now(), et=datetime.datetime(2020,12,1), d=24*60*60*60, desc="This is a contest", N=0):
        self.name=name
        self.etype = etype
        self.startTime=st
        self.endTime = et
        ...
        self.getDuration(self.etype, d)

    def getDuration(self, etype, d):
        if etype == 0:
